...
function placeXOrO(squareNumber) {
    ...
    } // End of function 'computersTurn'

    // This function parases the selectedSquares array to search for win conditions.
    // drawWinLine function is called to draw line if condition is met.
    function checkWinConditions() {
        // X 0, 1, 2 Condition
        if      (arrayIncludes('0X', '1X', '2X')) { drawWinLine(50, 100, 558, 100); }// End IF
        // X 3, 4, 5 Condition
        else if (arrayIncludes('3X', '4X', '5X')) { drawWinLine(50, 304, 558, 304); } // End ELSE IF
        // X 6, 7, 8 Condition
        else if (arrayIncludes('6X', '7X', '8X')) { drawWinLine(50, 508, 558, 508); } // End ELSE IF
        // X 0, 3, 6 Condition
        else if (arrayIncludes('0X', '3X', '6X')) { drawWinLine(100, 50, 100, 558); } // End ELSE IF
        // X 1, 4, 7 Condition
        else if (arrayIncludes('1X', '4X', '7X')) { drawWinLine(304, 50, 304, 558); } // End ELSE IF
        // X 2, 5, 8 Condition
        else if (arrayIncludes('2X', '5X', '8X')) { drawWinLine(508, 50, 508, 558); } // End ELSE IF
        // X 6, 4, 2 Condition
        else if (arrayIncludes('6X', '4X', '2X')) { drawWinLine(100, 508, 510, 90); } // End ELSE IF
        // X 0, 4, 8 Condition
        else if (arrayIncludes('0X', '4X', '8X')) { drawWinLine(100, 100, 520, 520); } // End ELSE IF
        // O 0, 1, 2 Condition
        if      (arrayIncludes('0O', '1O', '2O')) { drawWinLine(50, 100, 558, 100); } // End ELSE IF
        // O 3, 4, 5 Condition
        else if (arrayIncludes('3O', '4O', '5O')) { drawWinLine(50, 304, 558, 304); } // End ELSE IF
        // O 6, 7, 8 Condition
        else if (arrayIncludes('6O', '7O', '8O')) { drawWinLine(50, 508, 558, 508); } // End ELSE IF
        // O 0, 3, 6 Condition
        else if (arrayIncludes('0O', '3O', '6O')) { drawWinLine(100, 50, 100, 558); } // End ELSE IF
        // O 1, 4, 7 Condition
        else if (arrayIncludes('1O', '4O', '7O')) { drawWinLine(304, 50, 304, 558); } // End ELSE IF
        // O 2, 5, 8 Condition
        else if (arrayIncludes('0O', '5O', '8O')) { drawWinLine(508, 50, 508, 558); } // End ELSE IF
        // O 6, 4, 2 Condition
        else if (arrayIncludes('6O', '4O', '2O')) { drawWinLine(100, 508, 510, 90); } // End ELSE IF
        // O 0, 4, 8 Condition
        else if (arrayIncludes('0O', '4O', '8O')) { drawWinLine(100, 100, 520, 520); } // End ELSE IF
        ...
        } // End of function 'arrayIncludes'
    } // End of function 'checkWinConditions'
    ...
    function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
        ...
        } // End of function 'animateLineDrawing'
